...
export function Cadastro() {
  ...
  return (
    <div className="min-h-svh w-full bg-gradient-to-b from-background to-background/95 flex flex-col items-center pt-8 md:justify-center pb-32 px-4 overflow-y-auto scroll-smooth">
